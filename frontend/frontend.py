...
@app.route('/accountmodel/<int:query>', methods=["GET"])
def get_account_by_querymodel(query: AccountQueryModel):
...
@app.route('/articlemodel/<int:id>', methods=["GET"])
def get_article_by_querymodel(query: ArticleModel):
